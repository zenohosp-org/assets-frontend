        ...
        <div className="app-page">
            <header className="app-page-header">
                <div className="app-page-title-wrapper">
                    ...
                    <p className="app-page-subtitle">Track health logs, repairs, and service costs for all assets.</p>
                </div>
            ...
            <div className="app-stats-grid">
                <div className="maintenance-stat-card-orange">
                    ...
                    <div>
                        <p className="maintenance-stat-label-orange">Critical Repairs</p>
                        <p className="maintenance-stat-value-orange">{records.filter(r => r.type === 'REPAIR').length}</p>
                    </div>
                </div>
                ...
                <div className="app-table-container">
                    <table className="app-table">
                        ...
                        <tbody className="app-table-tbody">
                            {loading ? (
                                <tr><td colSpan="5" className="app-table-td text-center py-8">Analyzing maintenance history...</td></tr>
                            ) : filteredRecords.length === 0 ? (
                                <tr><td colSpan="5" className="app-table-td text-center py-8">No maintenance records found.</td></tr>
